 ...
 */
final class Version20230827091310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE game_name game_name VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE user_name user_name VARCHAR(30) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE game_name game_name VARCHAR(255) NOT NULL');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74 ON user');
        $this->addSql('ALTER TABLE user CHANGE user_name user_name VARCHAR(20) NOT NULL');
    }
}
