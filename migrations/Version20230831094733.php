 ...
 */
final class Version20230831094733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, event_game_id INT NOT NULL, event_admin_id INT NOT NULL, event_name VARCHAR(100) NOT NULL, event_description LONGTEXT NOT NULL, event_start_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', event_end_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', event_max_player INT NOT NULL, INDEX IDX_3BAE0AA761D870AA (event_game_id), INDEX IDX_3BAE0AA722C76BC0 (event_admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
