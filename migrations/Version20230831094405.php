 ...
 */
final class Version20230831094405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE user_name user_name VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, DROP created_at, CHANGE email email VARCHAR(255) NOT NULL, CHANGE user_name user_name VARCHAR(30) NOT NULL');
    }
}
